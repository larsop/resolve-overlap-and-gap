...
AS $$
DECLARE
validate_topoplogy_for_each_run boolean =false; -- if set to true, it will do topology.ValidateTopology at each loop return if it's error 
BEGIN
...
validate_topoplogy_for_each_run);
