...
CALL resolve_overlap_gap_run('test_data.overlap_gap_input_t2','c1','geom',4258,false,'test_topo_t2',0.00001,0.0,false,49,5,4);
...
-- Call function to resolve overlap and gap in the function in test_data.overlap_gap_input_t1 which we just testet for overlap
CALL resolve_overlap_gap_run('test_data.overlap_gap_input_t3','c1t3','geo',25833,true,'test_topo_t3',1.0,0.0,false,49,5,4);
