...
DECLARE
  ...
  run_add_border_line_as_single_thread boolean default true; --  if set to false, it will in many cases generate topo errors beacuse of running in many parralell threads
